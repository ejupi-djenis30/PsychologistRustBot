...
ELIZA Lab has four explicit layers:
...
- Application version: Cargo and release archives, currently `1.2.0`.
...
- Unknown JSON fields, versions, malformed fingerprints, divergent vectorizer configs, invalid
  feature names, duplicate vocabulary entries, non-finite values, and non-rectangular parameters
